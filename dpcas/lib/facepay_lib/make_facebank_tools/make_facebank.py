...
if __name__ == '__main__':
    ...
    # 加载模型
    if os.access("/models/yaoxiaoying/models/wyw2smodels/model_ir_se50.pth",os.F_OK):
        model_.load_state_dict(torch.load("/models/yaoxiaoying/models/wyw2smodels/model_ir_se50.pth"))
